...
const StudentTimetablePage: React.FC = () => {
  ...
  return (
    <div>
      <div className="mb-6"><h1 className="text-2xl font-bold text-gray-900">My Timetable</h1><p className="text-gray-500">Your weekly class schedule</p></div>
      <div className="bg-white rounded-xl border overflow-hidden">
        <table className="w-full">
          ...
          <tbody className="divide-y">
            {timetable.length === 0 ? (
              <tr><td colSpan={5} className="px-4 py-8 text-center text-gray-500">No timetable entries available.</td></tr>
