...
const TeacherLayout: React.FC = () => {
  ...
  const navItems = [
    ...
    { to: '/teacher/exams', icon: FileText, label: 'Exams & Marks' },
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <aside className={`fixed inset-y-0 left-0 z-50 w-64 bg-emerald-900 text-white transform transition-transform duration-200 ease-in-out lg:translate-x-0 ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'}`}>
